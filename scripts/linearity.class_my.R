...
#' @export
linearity.class_my <- function(...) {
  UseMethod("linearity.class_my")
}

#' @rdname linearity.class
#' @export
linearity.class_my.default <- function(x, y, measures="all", ...) {
...
#' @rdname linearity.class
#' @export
linearity.class_my.formula <- function(formula, data, measures="all", ...) {
  ...
  linearity.class_my.default(modFrame[, -1, drop=FALSE], modFrame[, 1, drop=FALSE],
                          measures, ...)
}
