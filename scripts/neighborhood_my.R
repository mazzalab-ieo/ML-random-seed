...
#' @export
neighborhood_my <- function(...) {
  UseMethod("neighborhood_my")
}

#' @rdname neighborhood
#' @export
neighborhood_my.default <- function(x, y, measures="all", mst.package = "igraph", ...) {
...
#' @rdname neighborhood
#' @export
neighborhood_my.formula <- function(formula, data, measures="all", mst.package = "igraph", ...) {
  ...
  neighborhood_my.default(modFrame[, -1, drop=FALSE], modFrame[, 1, drop=FALSE],
